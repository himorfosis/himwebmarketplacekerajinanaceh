...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>Aceh</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Pengrajin</b></span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="?hal=profil" class="btn btn-default btn-flat">Profil</a>
                </div>
...
<!--           <a href="#"><i class="fa fa-circle text-success"></i> Online</a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?= ($hal=='produk')?'class="active"':'' ?>><a href="?hal=produk"><i class="fa fa-user"></i> <span>Produk</span></a></li>

        <li <?= ($hal=='pemesanan')?'class="active"':'' ?>><a href="?hal=pemesanan"><i class="fa fa-user"></i> <span>Pemesanan</span></a></li>

        <li <?= ($hal=='profil')?'class="active"':'' ?>><a href="?hal=profil"><i class="fa fa-user"></i> <span>Profil</span></a></li>
