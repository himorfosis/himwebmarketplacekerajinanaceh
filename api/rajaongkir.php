...
<?php
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_HTTPHEADER => array(
	    "key: 5f2c707e94f2d3d91e3b8f5d0e93a6e3"   // key 
	  ),
	));


	//Get Data Kabupaten Pengirim
	...
	$(document).ready(function(){
		$('#provinsi').change(function(){
			...
			var prov = $('#provinsi').val();
      		...
      		$.ajax({
            	type : 'GET',
           		url : 'http://localhost/jualkerajinan/api/cek_kabupaten.php',
            	data :  'prov_id=' + prov,
		...
		$("#cek").click(function(){
			...
			var berat = $('#berat').val();
      		...
      		$.ajax({
            	type : 'POST',
           		url : 'http://localhost/jualkerajinan/api/cek_ongkir.php',
